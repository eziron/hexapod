...
class Hexapod():
    ...
    servo_param = [
        ...
        [2130,True , -90, [0,0],[0,0]], #[0]  - N    P6 sv2
        [1560,True , 135, [0,0],[0,0]], #[1]  - N    P6 sv0
        [1990,False,   0, [0,0],[0,0]], #[2]  - inv  P5 sv1
        [2100,True , -90, [0,0],[0,0]], #[3]  - N    P5 sv2
        [1580,True ,  90, [0,0],[0,0]], #[4]  - N    P5 sv0
        [2070,False,   0, [0,0],[0,0]], #[5]  - inv  P4 sv1
        [2200,True , -90, [0,0],[0,0]], #[6]  - N    P4 sv2
        [1540,True ,  45, [0,0],[0,0]], #[7]  - N    P4 sv0
        [1570,False,  45, [0,0],[0,0]], #[8]  - inv  P3 sv0
        [770 ,False, -90, [0,0],[0,0]], #[9]  - inv  P3 sv2
        [930 ,True ,   0, [0,0],[0,0]], #[10] - N    P3 sv1
        [1500,False,  90, [0,0],[0,0]], #[11] - inv  P2 sv0
        [750 ,False, -90, [0,0],[0,0]], #[12] - inv  P2 sv2
        [1020,True ,   0, [0,0],[0,0]], #[13] - N    P2 sv1
        [1500,False, 135, [0,0],[0,0]], #[14] - inv  P1 sv0
        [800 ,False, -90, [0,0],[0,0]], #[15] - inv  P1 sv2
        [1630,False,   0, [0,0],[0,0]], #[16] - inv  P6 sv1
        [2000,True ,   0, [0,0],[0,0]], #[17] - N    P1 sv1
    ]
    ...
    Pierna_param = [
        ...
        [[14, 17, 15], [  80.0   , 165.0  ], True  ,[ 210.0, 295.0, 0.0]], #[0]
        [[11, 13, 12], [ 130.0   ,   0.0  ], True  ,[ 300.0,   0.0, 0.0]], #[1]
        [[ 8, 10,  9], [  80.0   ,-165.0  ], True  ,[ 210.0,-295.0, 0.0]], #[2]
        [[ 7,  5,  6], [ -80.0   ,-165.0  ], False ,[-210.0,-295.0, 0.0]], #[3]
        [[ 4,  2,  3], [-130.0   ,   0.0  ], False ,[-300.0,   0.0, 0.0]], #[4]
        [[ 1, 16,  0], [ -80.0   , 165.0  ], False ,[-210.0, 295.0, 0.0]], #[5]
