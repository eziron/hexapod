...
class Hexapod():
    ...
    servo_param = [
        ...
        [720 ,False, -90, [0,0],[0,0]], #[0]  - inv P5 sv2
        [1340,True ,   0, [0,0],[0,0]], #[1]  - N   P5 sv1
        [1550,True ,  90, [0,0],[0,0]], #[2]  - N   P5 sv0
        [1380,True ,   0, [0,0],[0,0]], #[3]  - N   P4 sv1
        [700 ,False, -90, [0,0],[0,0]], #[4]  - inv P4 sv2
        [1500,True ,  45, [0,0],[0,0]], #[5]  - N   P4 sv0
        [680 ,False, -90, [0,0],[0,0]], #[6]  - inv P6 sv2
        [1500,True , 135, [0,0],[0,0]], #[7]  - N   P6 sv0
        [1500,False, 135, [0,0],[0,0]], #[8]  - inv P1 sv0
        [1670,False,   0, [0,0],[0,0]], #[9]  - inv P1 sv1
        [1570,False,  45, [0,0],[0,0]], #[10] - inv P3 sv0
        [1750,False,   0, [0,0],[0,0]], #[11] - inv P3 sv1
        [2250,True , -90, [0,0],[0,0]], #[12] - N   P3 sv2
        [1500,False,  90, [0,0],[0,0]], #[13] - inv P2 sv0
        [2250,True , -90, [0,0],[0,0]], #[14] - N   P2 sv2
        [1680,False,   0, [0,0],[0,0]], #[15] - inv P2 sv1
        [1380,True ,   0, [0,0],[0,0]], #[16] - N   P6 sv1
        [2250,True , -90, [0,0],[0,0]], #[17] - N   P1 sv2
    ]
    ...
    Pierna_param = [
        ...
        [[ 8,  9, 17], [  80.0   , 155.0  ], True  ,[ 210.0, 285.0, 0.0]], #[0]
        [[13, 15, 14], [ 120.0   ,   0.0  ], True  ,[ 300.0,   0.0, 0.0]], #[1]
        [[10, 11, 12], [  80.0   ,-155.0  ], True  ,[ 210.0,-285.0, 0.0]], #[2]
        [[ 5,  3,  4], [ -80.0   ,-155.0  ], False ,[-210.0,-285.0, 0.0]], #[3]
        [[ 2,  1,  0], [-120.0   ,   0.0  ], False ,[-300.0,   0.0, 0.0]], #[4]
        [[ 7, 16,  6], [ -80.0   , 155.0  ], False ,[-210.0, 285.0, 0.0]], #[5]
        [62.8, 100.0, 141.584]  #[6] distancias entre ejes, m0, m1, m2
    ]
    ...
    all_duty_us = [2250,1670,1680,2250,1500,1500,1570,1750,1380,1500,720 ,1550,1340,1500 ,2500,1380,2250,700]
